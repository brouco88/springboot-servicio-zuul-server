...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter{
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		//.antMatchers(HttpMethod.PUT,"/api/productos/producto/{id}","/api/items/producto/{id}","/api/usuarios/usuarios/{id}").hasRole("ADMIN")
		//.antMatchers(HttpMethod.DELETE,"/api/productos/producto/{id}/eliminar","/api/items/producto/{id}/eliminar","/api/usuarios/usuarios/{id}").hasRole("ADMIN");
